...
create index idx_interview_sessions_event on public.interview_sessions (event_id);
create index idx_interview_sessions_started on public.interview_sessions (started_at desc);
...
create index idx_interview_analysis_session on public.interview_analysis (session_id);
