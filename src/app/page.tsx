    ...
    <div className="flex flex-1 flex-col bg-gradient-to-b from-indigo-50 to-white dark:from-zinc-950 dark:to-zinc-900">
      <main className="mx-auto flex w-full max-w-2xl flex-1 flex-col justify-center px-4 py-16 sm:py-24">
        ...
        <div className="mt-10 flex flex-col gap-3 sm:flex-row sm:items-center">
          ...
          <Link
            href="/interview?event=general&new=1"
        ...
        <p className="mt-4 max-w-md text-sm text-zinc-500">
          Opens the privacy notice first — tap <span className="font-medium text-zinc-700 dark:text-zinc-300">Continue</span>, then the chat begins (needs Supabase + OpenAI configured).
        </p>
